...
export const courseAttribution = "Inspired by the behavioral influence frameworks of Chase Hughes. For deeper mastery beyond Roventis Sourcing, explore his original works at chasehughes.com.";
...
export const lessons: Lesson[] = [
  // LESSON 1 — INTRODUCTION
  {
    ...
    drill: {
      ...
      checklist: [
        "100% cotton → The physical comfort and pride an employee feels wearing it, reducing staff turnover and boosting morale.",
        "4–6 week delivery → Certainty. The client can plan their event launch without anxiety.",
        "Custom sublimation → Significance. The client's brand stands distinctly apart from competitors."
      ]
    }
  },
  // LESSON 2 — FATHER FRAME
  {
    id: "father-frame",
    chapter: "Chapter 1",
    ...
    cards: [
      ...
      { type: "example", title: "When the client tests you", body: "Client says: \"We are talking to three other suppliers, so you need to give us your absolute best price.\"", example: { weak: "Oh, okay, let me see what discounts I can apply. We really want your business.", strong: "I completely understand. It's smart to look at your options. Our pricing is fixed because we don't compromise on the quality of the final product. If you are looking for the cheapest option, we probably aren't the right fit. But if you are looking for gear that actually lasts and elevates your brand, we should continue the conversation.", context: "Delivered with a calm, slightly amused tone. The Father Frame doesn't argue — it simply states the truth and offers a choice." } }
    ],
    drill: {
  ...
  // LESSON 4 — FATE MODEL
  {
    ...
    duration: "9 min",
    cards: [
      { type: "concept", title: "F — Focus", body: "Focus is about directing the client's attention exactly where you want it. You achieve this through pattern interrupts. If a client is distracted or running on autopilot, a sudden shift in your tone, a deliberate pause, or an unexpected statement will snap their focus back to you." },
      { type: "concept", title: "A — Authority", body: "Authority leverages the innate human tendency to obey perceived leaders. Use high-certainty, declarative language. Never hedge your statements with phrases like \"I think,\" \"maybe,\" or \"hopefully.\" Speak in absolutes. Your physical stillness and measured pacing further reinforce this authority." },
      { type: "concept", title: "T — Tribe", body: "Tribe activates the deep-seated need for belonging and social conformity. Use language that creates an \"Us vs. Them\" dynamic — the kind of company that values brand standards, versus the kind that cuts corners and pays for it later." },
      { type: "concept", title: "E — Emotion", body: "Emotion anchors your product to their deepest desires. You are not selling a custom-branded travel bag — you are selling the pride executives will feel carrying it through an airport, and the status it projects to their clients." },
  ...
  // LESSON 6 — OBJECTIONS
  {
    ...
    cards: [
      ...
      { type: "example", title: "Handling \"We don't have the budget right now\"", body: "Step 1 — Agree. Step 2 — Pivot to a goal they already stated.", example: { strong: "I completely understand. Managing cash flow is critical, especially this quarter. Earlier, you mentioned that your sales team is attending the national expo next month, and your primary goal was to ensure they look more professional than your main competitor. If we delay this order, they will be walking into that expo in their current, faded gear. Are you comfortable sacrificing that first impression at your biggest event of the year just to defer the cost by a few weeks?", context: "You haven't argued. You haven't dropped the price. You've simply made their objection conflict with their own goal." } }
    ],
    drill: {
      title: "Objection Aikido",
      instructions: "Write down the three most common objections you face — Price, Timing, Need to consult a partner. For each one, write out an \"Agree and Pivot\" script that ties the objection back to a goal the client stated earlier in the conversation.",
      checklist: [
  ...
  // LESSON 8 — CONCLUSION
  {
    ...
    duration: "4 min",
    cards: [
      { type: "concept", title: "It's not overnight", body: "Mastering behavioral sales is not an overnight process. It requires discipline, self-awareness, and relentless practice. As a Roventis affiliate, you have access to a premium product line, a verified lead pool, and a flawless fulfillment infrastructure. Your only job is to master the interaction." },
      ...
      { type: "concept", title: "Going deeper", body: "The psychological depth of this manual is rooted in the behavioral frameworks developed by Chase Hughes. To truly master these concepts beyond the scope of Roventis Sourcing, explore his original works at chasehughes.com." }
    ],
    drill: {
